...
export default App;`}),e.jsx(D,{rows:ms})]}),ms=[{prop:"className",desc:"自定义类名",type:"string",defaultVal:"-"}],us=()=>e.jsxs("div",{style:A,children:[e.jsxs("div",{style:N,children:["Footer ",e.jsx("span",{style:w,children:"底部装饰"})]}),e.jsx("div",{style:l,children:"Footer 组件 — 页面底部装饰图片，支持 sea（海）和 tree（树）两种类型。"}),e.jsxs("div",{style:{...T,padding:"40px 0"},children:[e.jsx("div",{style:l,children:"tree 类型（默认）"}),e.jsx(ie,{})]}),e.jsxs("div",{style:{...T,padding:"40px 0"},children:[e.jsx("div",{style:l,children:"sea 类型"}),e.jsx(ie,{type:"sea"})]}),e.jsx(I,{code:`import React from 'react';
...
);`}),e.jsx(D,{rows:ys})]}),ys=[{prop:"type",desc:"Footer 类型",type:"'sea' | 'tree'",defaultVal:"'tree'"},{prop:"className",desc:"自定义类名",type:"string",defaultVal:"-"},{prop:"style",desc:"自定义样式",type:"CSSProperties",defaultVal:"-"}],xs=[{prop:"name",desc:"图标名称",type:"IconName",defaultVal:"-",required:!0},{prop:"size",desc:"图标尺寸",type:"number | string",defaultVal:"24"},{prop:"bounce",desc:"弹跳动画",type:"boolean",defaultVal:"false"},{prop:"className",desc:"自定义类名",type:"string",defaultVal:"-"},{prop:"style",desc:"自定义样式",type:"CSSProperties",defaultVal:"-"}],fs=()=>e.jsxs("div",{style:A,children:[e.jsxs("div",{style:N,children:["Icon ",e.jsx("span",{style:w,children:"10 icons"})]}),e.jsx("div",{style:l,children:"基础用法"}),e.jsxs("div",{style:{display:"flex",gap:20,flexWrap:"wrap",alignItems:"center"},children:[e.jsx(R,{name:"icon-miles",size:32}),e.jsx(R,{name:"icon-camera",size:32}),e.jsx(R,{name:"icon-chat",size:32}),e.jsx(R,{name:"icon-design",size:32}),e.jsx(R,{name:"icon-map",size:32})]}),e.jsx("div",{style:l,children:"size 尺寸"}),e.jsxs("div",{style:{display:"flex",gap:20,alignItems:"center"},children:[e.jsx(R,{name:"icon-miles",size:16}),e.jsx(R,{name:"icon-miles",size:24}),e.jsx(R,{name:"icon-miles",size:32}),e.jsx(R,{name:"icon-miles",size:48})]}),e.jsx("div",{style:l,children:"bounce 弹跳动画（鼠标悬停查看效果）"}),e.jsxs("div",{style:{display:"flex",gap:20,alignItems:"center"},children:[e.jsx(R,{name:"icon-miles",size:32,bounce:!0}),e.jsx(R,{name:"icon-camera",size:32,bounce:!0}),e.jsx(R,{name:"icon-chat",size:32,bounce:!0})]}),e.jsx("div",{style:l,children:"图标列表"}),e.jsx("div",{style:{border:"1px solid #e8e2d6",borderRadius:12,overflow:"hidden",padding:"5px 16px"},children:de.map((t,a)=>e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:20,padding:"12px 5px",borderBottom:a<de.length-1?"1px dashed #f0e8d8":"none",background:"#fff"},children:[e.jsx(R,{name:t.name,size:32}),e.jsx("span",{style:{fontSize:14,color:"#725d42",fontFamily:"inherit"},children:t.label}),e.jsx("span",{style:{marginLeft:"auto",fontSize:12,color:"#a0936e",fontFamily:"'SF Mono', 'Fira Code', Consolas, monospace"},children:t.name})]},t.name))}),e.jsx(I,{code:`import React from 'react';
...
export default App;`}),e.jsx(D,{rows:gs})]})},ws=[{prop:"code",desc:"代码字符串",type:"string",defaultVal:"-",required:!0},{prop:"style",desc:"自定义样式",type:"CSSProperties",defaultVal:"-"},{prop:"className",desc:"自定义类名",type:"string",defaultVal:"-"}],ks=()=>e.jsxs("div",{style:A,children:[e.jsxs("div",{style:N,children:["CodeBlock ",e.jsx("span",{style:w,children:"代码高亮"})]}),e.jsx("div",{style:l,children:"基础用法"}),e.jsx("div",{style:M,children:e.jsx(oe,{code:`import React from 'react';
...
export default App;`})}),e.jsx("div",{style:l,children:"自定义样式"}),e.jsx("div",{style:M,children:e.jsx(oe,{code:`import React from 'react';
...
/>`,style:{borderRadius:5,backgroundColor:"#242c46ff"}})}),e.jsx(I,{code:`import React from 'react';
import { CodeBlock } from 'animal-island-ui';
...
export default App;`}),e.jsx(D,{rows:ws})]}),Ss=()=>{const[t,a]=r.useState(!0);return e.jsxs("div",{style:A,children:[e.jsxs("div",{style:N,children:["Loading ",e.jsx("span",{style:w,children:"加载动画"})]}),e.jsx("div",{style:l,children:"动森风格小岛 Loading 动画组件，带有漂浮的小岛、摇曳的树叶和游动的鱼。关闭时会从中间圆形透明扩散，露出底层内容。"}),e.jsx("div",{style:{marginBottom:16},children:e.jsx(m,{type:t?"default":"primary",onClick:()=>a(!t),children:t?"关闭 Loading":"开启 Loading"})}),e.jsxs("div",{style:{...T,position:"relative",height:800,padding:0,overflow:"hidden"},children:[e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(135deg, #ffd6a5 0%, #fdffb6 25%, #caffbf 50%, #9bf6ff 75%, #a0c4ff 100%)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:28,fontWeight:600,color:"#333"},children:"底层内容 · Underlying Content"}),e.jsx(ye,{active:t,style:{height:"100%",position:"absolute",inset:0}})]}),e.jsx(I,{code:`import React, { useState } from 'react';
...
};`}),e.jsx(D,{rows:As})]})},As=[{prop:"active",desc:"是否显示加载动画",type:"boolean",defaultVal:"true"},{prop:"className",desc:"自定义类名",type:"string",defaultVal:"-"},{prop:"style",desc:"自定义样式",type:"CSSProperties",defaultVal:"-"}],Ns=()=>{const[t,a]=r.useState(!0),[n,i]=r.useState(!1),d=[{title:"岛民",dataIndex:"name",width:120},{title:"年龄",dataIndex:"age",width:80,align:"center"},{title:"岛屿",dataIndex:"island"},{title:"喜欢的水果",dataIndex:"fruit"},{title:"爱好",dataIndex:"hobby",render:p=>{const u=p,v={音乐:{bg:"rgba(147, 112, 219, 0.15)",color:"#9370db"},运动:{bg:"rgba(255, 140, 0, 0.15)",color:"#ff8c00"},唱歌:{bg:"rgba(255, 99, 71, 0.15)",color:"#ff6347"},钓鱼:{bg:"rgba(30, 144, 255, 0.15)",color:"#1e90ff"},画画:{bg:"rgba(255, 105, 180, 0.15)",color:"#ff69b4"}}[u]||{bg:"rgba(25, 200, 185, 0.15)",color:"#19c8b9"};return e.jsx("span",{style:{padding:"4px 12px",background:v.bg,borderRadius:20,color:v.color,fontWeight:600,fontSize:12},children:u})}}],s=[{key:"1",name:"豆狸",age:26,island:"彩虹岛",fruit:"苹果",hobby:"音乐"},{key:"2",name:"粒狸",age:24,island:"彩虹岛",fruit:"橘子",hobby:"运动"},{key:"3",name:"西施惠",age:28,island:"好评岛",fruit:"樱桃",hobby:"唱歌"},{key:"4",name:"喻哥",age:30,island:"无人岛",fruit:"梨",hobby:"钓鱼"},{key:"5",name:"小润",age:22,island:"摸鱼岛",fruit:"桃子",hobby:"画画"}],o=()=>{i(!0),setTimeout(()=>i(!1),2e3)};return e.jsxs("div",{style:A,children:[e.jsxs("div",{style:N,children:["Table ",e.jsx("span",{style:w,children:"表格"})]}),e.jsx("div",{style:l,children:"数据表格组件，支持斑马纹、边框、加载状态等常用功能。"}),e.jsxs("div",{style:{marginBottom:16,display:"flex",gap:16,flexWrap:"wrap"},children:[e.jsxs(m,{type:t?"primary":"default",onClick:()=>a(!t),children:["斑马纹 ",t?"✓":"✗"]}),e.jsx(m,{type:"primary",onClick:o,disabled:n,children:n?"加载中...":"模拟加载"})]}),e.jsx("div",{style:{...T,padding:0,overflow:"hidden"},children:e.jsx(me,{columns:d,dataSource:s,striped:t,loading:n})}),e.jsx(I,{code:`import React, { useState } from 'react';
...
export default App;`}),e.jsx(D,{rows:Ms})]}),Hs=()=>e.jsxs("div",{style:A,children:[e.jsxs("div",{style:N,children:["Cursor ",e.jsx("span",{style:w,children:"光标"})]}),e.jsxs("p",{style:l,children:["Cursor 组件通过 CSS cursor 属性将子元素的鼠标光标替换为自定义手指图标。 默认 ",e.jsx("code",{children:"forceAll=true"}),"全覆盖所有后代；设置 ",e.jsx("code",{children:"forceAll=false"})," 可保留 a/button 的 pointer 和输入框的 text 语义。"]}),e.jsxs("div",{style:T,children:[e.jsx("div",{style:l,children:"forceAll=true（默认）：全覆盖"}),e.jsx(ne,{children:e.jsx("div",{style:{...te,padding:24,textAlign:"center"},children:"鼠标移入此区域将显示自定义光标"})}),e.jsx("div",{style:l,children:"forceAll=false：保留原生光标语义"}),e.jsx(ne,{forceAll:!1,children:e.jsxs("div",{style:{...te,padding:24,flexDirection:"column",alignItems:"center",gap:12},children:[e.jsx("div",{children:"鼠标移入此区域，交互元素恢复语义光标"}),e.jsxs("div",{style:{display:"flex",gap:16,flexWrap:"wrap",alignItems:"center",justifyContent:"center"},children:[e.jsx("a",{href:"#",onClick:t=>t.preventDefault(),children:"链接 (pointer)"}),e.jsx("button",{type:"button",children:"按钮 (pointer)"}),e.jsx("button",{type:"button",disabled:!0,children:"禁用 (not-allowed)"}),e.jsx("input",{type:"text",placeholder:"输入框 (text)",style:{padding:"4px 8px"}}),e.jsx("span",{style:{userSelect:"text"},children:"可选中文本 (默认)"})]})]})})]}),e.jsx(I,{code:`import React from 'react';
...
export default App;`}),e.jsx(D,{rows:Ls})]})},Us=()=>{const[t,a]=r.useState(0);return e.jsxs("div",{style:A,children:[e.jsxs("div",{style:N,children:["Typewriter ",e.jsx("span",{style:w,children:"打字机"})]}),e.jsxs("div",{style:T,children:[e.jsxs("div",{children:[e.jsx("div",{style:l,children:"基础用法"}),e.jsx("div",{style:{...te,marginBottom:20},children:e.jsx(ae,{trigger:t,children:"你好，欢迎来到动物岛！今天的天气真不错呢～"})})]}),e.jsxs("div",{children:[e.jsx("div",{style:l,children:"保留多行与富内容 (速度 40ms)"}),e.jsx("div",{style:{...te,flexDirection:"column",alignItems:"flex-start",marginBottom:20,gap:8},children:e.jsxs(ae,{speed:40,trigger:t,children:[e.jsx("div",{children:"第一行：钓到石头了！"}),e.jsx("div",{children:"第二行：竟然连这种都能钓起来..."}),e.jsx("div",{style:{color:"#FD9303",fontWeight:700},children:"第三行：继续加油吧！"})]})})]}),e.jsx("div",{style:C.row,children:e.jsx(m,{type:"primary",onClick:()=>a(n=>n+1),children:"重新播放"})})]}),e.jsx(I,{code:`import React, { useState } from 'react';
...
export default App;`}),e.jsx(D,{rows:Ys})]})},Ys=[{prop:"children",desc:"需要逐字显示的内容，支持 ReactNode",type:"ReactNode",defaultVal:"-"},{prop:"speed",desc:"每字间隔 (ms)",type:"number",defaultVal:"90"},{prop:"trigger",desc:"值变化时重新播放",type:"unknown",defaultVal:"-"},{prop:"autoPlay",desc:"是否自动从头开始播放",type:"boolean",defaultVal:"true"},{prop:"onDone",desc:"播放完成回调",type:"() => void",defaultVal:"-"}],qs=()=>e.jsxs("div",{style:A,children:[e.jsxs("div",{style:N,children:["Divider ",e.jsx("span",{style:w,children:"5 types"})]}),e.jsx("div",{style:l,children:"line-brown"}),e.jsx(J,{type:"line-brown"}),e.jsx("div",{style:l,children:"line-teal"}),e.jsx(J,{type:"line-teal"}),e.jsx("div",{style:l,children:"line-white"}),e.jsx("div",{style:{background:"#333",padding:10},children:e.jsx(J,{type:"line-white"})}),e.jsx("div",{style:l,children:"line-yellow"}),e.jsx(J,{type:"line-yellow"}),e.jsx("div",{style:l,children:"wave-yellow"}),e.jsx(J,{type:"wave-yellow"}),e.jsx(I,{code:`import React from 'react';
