...
export default App;`}),e.jsx(A,{rows:is})]}),os=()=>{const[t,a]=n.useState(!0);return e.jsxs("div",{style:w,children:[e.jsxs("div",{style:k,children:["Loading ",e.jsx("span",{style:g,children:"加载动画"})]}),e.jsx("div",{style:s,children:"动森风格小岛 Loading 动画组件，带有漂浮的小岛、摇曳的树叶和游动的鱼。关闭时会从中间圆形透明扩散，露出底层内容。"}),e.jsx("div",{style:{marginBottom:16},children:e.jsx(p,{type:t?"default":"primary",onClick:()=>a(!t),children:t?"关闭 Loading":"开启 Loading"})}),e.jsxs("div",{style:{...B,position:"relative",height:800,padding:0,overflow:"hidden"},children:[e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(135deg, #ffd6a5 0%, #fdffb6 25%, #caffbf 50%, #9bf6ff 75%, #a0c4ff 100%)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:28,fontWeight:600,color:"#333"},children:"底层内容 · Underlying Content"}),e.jsx(me,{active:t,style:{height:"100%",position:"absolute",inset:0}})]}),e.jsx(S,{code:`import React, { useState } from 'react';
